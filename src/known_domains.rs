...
/// keyed by $D$.
///
/// The `-M` entries are the hash domains of the Orchard commitments, and
/// `z.cash:ZSA-NoteCommit-M` is the OrchardZSA note commitment hash domain from
...
static Q: [Entry; 4] = [
    ...
    (
        ...
        pallas::Affine::from_xy_unchecked(
            pallas::Base::from_raw([
                0x7e08_e142_2dbf_ebcf,
                0x0212_6a73_1a27_bcc7,
                0xc1af_e141_094b_adbf,
                0x01e4_4b03_b1e4_cae0,
            ]),
            pallas::Base::from_raw([
                0x4363_b6b6_5650_fbdc,
                0xb0a1_6f4f_16f1_61fe,
                0xc46e_3974_62d0_614f,
                0x1e13_61c4_1fef_4919,
            ]),
        ),
    ),
];
